<div class="popupWrapper">
		...
		<div class="mainMenu__container tripleContainer__center">
			<div class="mainMenu__header">
				...
				<div class="mainMenu__language langSwitch">
					...
					<div class="langSwitch__item langSwitch__item_en langSwitch__item_white">
						 En
					</div>
				</div>
				<div class="mainMenu__close menuAnimatedButton">
					<div class="menuAnimatedButton__menuLine menuAnimatedButton__menuLine_top">
					</div>
					<div class="menuAnimatedButton__menuLine menuAnimatedButton__menuLine_middle">
					</div>
					<div class="menuAnimatedButton__menuLine menuAnimatedButton__menuLine_bottom">
					</div>
			...
			<div class="mainMenu__content">
				<div class="mainMenu__list mainMenu__list_mobile">
					<div class="mainMenu__item">
						<div class="mainMenu__label mainMenu__label_tab">
							 О компании
						</div>
 ...
 <a href="#">Контакты</a>
							...
							<ul class="mainMenu__subList">
								<li class="mainMenu__subItem mainMenu__subItem_big mainMenu__subItem_thin">+375 (29) 322-00-20 </li>
								<li class="mainMenu__subItem mainMenu__subItem_thin"><a href="mailto:info@likeit.by">info@likeit.by</a></li>
								<li class="mainMenu__subItem mainMenu__subItem_thin">Минск, ул. Казинца 11а<br>
								 Барановичи, ул. Куйбышева,111 офис 211 </li>
							</ul>
						</div>
					</div>
				</div>
				<div class="mainMenu__positioned">
					 <!--<a class="mainMenu__link mainLink mainLink_white" href="#">Рассчитать
                        проект</a>-->
	...
	<div class="popupVideo">
		<div id="loading-center">
			<div id="loading-center-absolute">
				...
				<div class="object" id="object_five">
				</div>
				<div class="object" id="object_six">
				</div>
				<div class="object" id="object_seven">
				</div>
				<div class="object" id="object_eight">
				</div>
			</div>
		</div>
	</div>
